...
//    public static final int RECEIVE_ALBUM_TYPE_VALUE=1;
    ...
    public static final int UPLOAD_NOTIFICATION_ID=101;
    public static final int RECEIVED_PICTURE_NOTIFICATION_ID=102;

    public static final long PICTURE_EXPIRE_DURATION=1000*60*60*24;//PICTURE 존재 시간 // 이 시간 이후에 자동 삭제
...
//    public static final String SERVER_URL="https://52.68.142.41:1337";
    ...
    public static final String PREF_AUTO_DOWNLOAD ="prefAutoSave";
    public static final String PREF_AUTO_DOWNLOAD_MODE ="prefAutoSaveMode";
    public static final String PREF_AUTO_SAVE_BASIC_CONFIG="prefAutoSaveBasicConfig";
    public static final String PREF_AUTO_DOWNLOAD_INDIVIDUAL="prefAutoDownloadIndividual";
    public static final String PREF_AUTO_DOWNLOAD_GROUP="prefAutoDownloadGroup";
...
//    public static final String PREF_LOGIN = "pref_login";//로그인시 설정
    ...
    //share pref
    public static final String PREF_SHARE_INDIVIDUAL = "pref_shareIndividual";//공유 설정 친구 목록 (contact id 목록 저장)
...
//    public static final String PREF_SHARE_FRIEND="pref_shareFriend";
    ...
    public static final String PREF_LOCAL_SYNC_CONTAT_TIME="pref_localSyncContactUTCTime";// 로컬에서 받아온 연락처와 최종 동기화 시간
    public static final String PREF_SYNC_CONTACT_TIME = "pref_syncContactUTCTime";// 서버에서 받아온 연락처 최종 동기화 시간

    public static final String PREF_SELECTED_ALBUM_TYPE="pref_selectedAlbumType";
    ...
    public static final int PREF_ALARM_MODE_VIBRATE =1;
    public static final int PREF_ALARM_MODE_MUTE =2;
    ...
    public static final int PREF_AUTO_SAVE_BASIC_NOBODY=3;
    ...
    public static final int PREF_SORT_BY_PICTURE=0;
    public static final int PREF_SORT_BY_DATE=1;

    public static final int PREF_SELECTED_SEND_ALBUM=0;
    public static final int PREF_SELECTED_RECEIVED_ALBUM=1;
...
//    public static final int PREF_CONT_11_4=8;//1:1비율 한번 촬영
    ...
    public static final String PREF_SHARE_INDIVIDUAL_DEFAULT ="[]";
    ...
    public static final int PREF_ALBUM_SORT_TYPE_DEFAULT = PREF_SORT_BY_PICTURE;
    ...
    public static final long PREF_LOCAL_SYNC_CONTAT_TIME_DEFAULT=0;
    ...
    public static final int PREF_AUTO_SAVE_BASIC_CONFIG_DEFAULT=PREF_AUTO_SAVE_BASIC_GROUP;
    public static final boolean PREF_AUTO_DOWNLOAD_INDIVIDUAL_DEFAULT=false;
    public static final boolean PREF_AUTO_DOWNLOAD_GROUP_DEFAULT=false;



    //sync 시간 간격
//    public static final long SYNC_FRIEND_GAP=60*1000*10;//10분에 한번씩 동기화
    public static final long SYNC_CONTACT_GAP = 60 * 1000 * 10 * 999999999;//10분에 한번씩 동기화
...
//    public static final long SYNC_CONTACT_GAP=0;//15분에 한번씩 동기화
    ...
    public static final int NUM_LOAD_NOTIFICATION=20;

    //UploadActivity
    public static final int THUMB_NAIL_SIZE = 64;

    //album
    public static final int COL_NUM_ALBUM=3;
