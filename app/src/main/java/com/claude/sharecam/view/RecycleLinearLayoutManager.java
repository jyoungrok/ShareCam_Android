...
import com.claude.sharecam.BuildConfig;

import java.lang.reflect.Field;

public class RecycleLinearLayoutManager extends android.support.v7.widget.LinearLayoutManager {
    ...
    @SuppressWarnings("UnusedDeclaration")
    public RecycleLinearLayoutManager(RecyclerView view) {
    ...
    @SuppressWarnings("UnusedDeclaration")
    public RecycleLinearLayoutManager(RecyclerView view, int orientation, boolean reverseLayout) {
